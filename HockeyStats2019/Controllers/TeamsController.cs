...
namespace HockeyStats2019.Controllers
{
    public class TeamsController : Controller
    {
        ...
        public TeamsController(HockeyStats2019Context context)
        {
            _context = context;
        }
        ...
        {
            var hockeyStats2019Context = _context.Team.Include(t => t.AssCoach).Include(t => t.AssCoach1).Include(t => t.HeadCoach);
        ...
        public async Task<IActionResult> Create([Bind("Id,TeamName,PersonId,PersonId1,PersonId2")] Team team)
        {
            ...
            ViewData["PersonId1"] = new SelectList(_context.Person, "Id", "FullName", team.PersonId1);
            ViewData["PersonId2"] = new SelectList(_context.Person, "Id", "FullName", team.PersonId2);
            ViewData["PersonId"] = new SelectList(_context.Person, "Id", "FullName", team.PersonId);
            return View(team);
        }
