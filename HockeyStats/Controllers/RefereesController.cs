...
namespace HockeyStats.Controllers
{
    public class RefereesController : Controller
    {
        ...
        {
            var applicationDbContext = _context.Referee.Include(r => r.RefCategory).Include(r => r.RefCategoryType).Include(r => r.RefDistrikt).Include(r => r.RefType);
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            var referee = await _context.Referee
                ...
                .Include(r => r.RefCategoryType)
                .Include(r => r.RefDistrikt)
                .Include(r => r.RefType)
        ...
        public IActionResult Create()
        {
            ...
            ViewData["RefCategoryTypeId"] = new SelectList(_context.RefCategoryType, "Id", "Id");
            ViewData["RefDistriktId"] = new SelectList(_context.RefDistrikt, "Id", "Id");
        ...
        public async Task<IActionResult> Create([Bind("Id,RefereeName,IdentityUserId,RefTypeId,RefCategoryId,RefCategoryTypeId,RefDistriktId")] Referee referee)
        {
            ...
            ViewData["RefCategoryTypeId"] = new SelectList(_context.RefCategoryType, "Id", "Id", referee.RefCategoryTypeId);
            ViewData["RefDistriktId"] = new SelectList(_context.RefDistrikt, "Id", "Id", referee.RefDistriktId);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,RefereeName,IdentityUserId,RefTypeId,RefCategoryId,RefCategoryTypeId,RefDistriktId")] Referee referee)
        {
            if (id != referee.Id)
            {
                return NotFound();
